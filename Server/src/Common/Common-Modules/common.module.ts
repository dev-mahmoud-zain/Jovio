...
@Module({
    ...
    providers: [UserRepository, EncryptionService, EmailService, OtpService, OtpRepository, CookiesService, JwtRepository ],

    exports: [UserRepository, EncryptionService, EmailService, OtpService, OtpRepository, MongooseModule, CookiesService, JwtRepository],
